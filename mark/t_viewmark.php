  ...
  <div class="content content_inside">
    <div class="header_text">
      ...
      <div class="top_common_bar">
        ...
        <div class="obj_right">
        	<a class="btn btn_add_new btn-success" href="<?php echo WEB_URL; ?>mark/t_addmark.php"><i class="fa fa-plus"></i>&nbsp;Añadir Calificacion</a>&nbsp;<a class="btn btn_add_new btn-success" href="<?php echo WEB_URL; ?>t_dashboard.php"><i class="fa"></i>Ventana Principal</a></div>
        </div>
      </div>
