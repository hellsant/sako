...
<link type="text/css" href="<?php echo WEB_URL; ?>css/bootstrap.css" rel="stylesheet" />
  <div class="content">
    <div class="header_text">Bienvenido a la Ventana de Examenes</div><!-- <div class="header_text">Welcome To Exam. Dashboard</div>  -->
    <div class="top_common_bar">
        <div class="obj_right" style="padding-right:10px !important;">
        	<a class="btn btn_add_new btn-success" href="<?php echo WEB_URL; ?>dashboard.php"><i class="fa"></i>Ventana Principal</a></div>
        </div>
    ...
    <div class="link_box">
        ...
        <div class="link_box_text">Añadir Examen.</div>
      </div>
      <div class="link_box">
        ...
        <div class="link_box_text">Programar Examen</div>
      </div>
      <div class="link_box">
        ...
        <div class="link_box_text">Fecha Examen</div>
      </div>
      <div class="link_box">
        ...
        <div class="link_box_text">Exam.Programdos</div>
      </div>
      <div style="clear:both"></div>
    </div>
    <br/><br/>
