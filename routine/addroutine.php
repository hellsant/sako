...
if(isset($_POST['dllStClassId'])){
	if(isset($_POST['hdn']) && $_POST['hdn'] == '0'){
	  $sql =mysqli_query($link,"INSERT INTO `tbl_add_routine`(`r_class_id`,`r_subject_id`, `routine_day`, `routine_time_start`,`start_am_pm`,`routine_time_end`,`end_am_pm`,`routine_room`) VALUES ('$_POST[dllStClassId]','$_POST[dllESSubjectId]','$_POST[ddlDays]','$_POST[txtRStartTime]','$_POST[ddlStartAMPM]','$_POST[txtREndTime]','$_POST[ddlEndAMPM]','$_POST[txtRoomNo]')");
...
if(isset($_GET['id']) && $_GET['id'] != ''){
	$result = mysqli_query($link,"SELECT * FROM tbl_add_routine where routine_id = '" . $_GET['id'] . "'");
          ...
          <div class="form-group">
            ...
            <div class="col-sm-6">
              <select class="form-control" id="dllESSubjectId" name="dllESSubjectId">
                ...
                <?php 
				  	if($r_subject_id != 0){
					$result_class = mysqli_query($link,"SELECT * from tbl_add_subject where sb_class_id = '" . (int)$r_class_id . "' order by sb_name asc");
					while($row_class = mysqli_fetch_array($result_class)){
				 ?>
