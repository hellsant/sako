...
?>
  ...
  <?php } ?>
  <div>
    <div style="font-size:20px; font-weight:bold; color:black; text-align:left; margin-top:20px; margin-bottom:20px; text-decoration:underline;">Estudiante Informacion:</div>
	...
	if($row = mysqli_fetch_array($result)){?>
      <table class="gridtable" align="left"  style="width:100%">
        ...
        <tr>
          <td style="font-weight:bold;">Nombre Perfil :</td>
