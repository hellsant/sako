...
$id = '';
   $result = mysqli_query($link,"Select * from tbl_add_teacher where teacher_id='".$_GET['tid']."'");
...
?>
  ...
  <?php } ?>
  <div>
    <div style="font-family:Georgia, 'Times New Roman', Times, serif; font-style:italic; font-size:18px; font-weight:bold; color:red; text-align:left; margin-top:20px; margin-bottom:20px;">Informacion Docente:</div>
	...
	if($row = mysqli_fetch_array($result)){?>
      <table class="gridtable" align="left"  style="width:100%">
        ...
        <tr>
          <td style="font-weight:bold;">Inicio de Trabajo :</td>
