...
if(isset($_POST['txtTitle'])){
	if(isset($_POST['hdn']) && $_POST['hdn'] == '0'){
	  $sql = mysqli_query($link,"INSERT INTO `tbl_add_notice`(`n_title`,`date`,`permission`,`notice`) VALUES ('$_POST[txtTitle]','$_POST[txtDate]','$_POST[txtPermission]','$_POST[txtNotice]')");
...
if(isset($_GET['id']) && $_GET['id'] != ''){
	$result = mysqli_query($link,"SELECT * FROM tbl_add_notice where n_id = '" . $_GET['id'] . "'");
...
<div class="content">
  ...
  <div class="main_content">
    <div class="main_content_left">
      ...
      <div class="my_button"><a class="btn btn_back btn-success" href="<?php echo WEB_URL; ?>notice/notice_list.php">Lista de Noticias</a></div>
    </div>
    <div class="frmstyle">
      <form enctype="multipart/form-data" method="post" role="form" class="form-horizontal">
        <div class="form-group">
          <label class="col-sm-2 control-label" for="txtTitle"> Titulo </label>
          <div class="col-sm-6">
        ...
        <div class="form-group">
          <label class="col-sm-2 control-label" for="txtDate"> Fecha </label>
          <div class="col-sm-6">
            <input type="text" value="<?php echo $date;?>" name="txtDate" id="txtDate" class="form-control datepicker">
          </div>
          <span class="col-sm-4 control-label"> </span> </div>
		  <div class="form-group">
            <label class="col-sm-2 control-label" for="txtPermission"> Dirigido a: </label>
            <div class="col-sm-6">
              <select class="form-control" id="txtPermission" name="txtPermission">
                <option value="-1">--Select--</option>
				<option <?php if($permission == 'teacher'){echo 'selected';}?> value="teacher">Docente</option>
				<option <?php if($permission == 'student'){echo 'selected';}?> value="student">Estudiante</option>
				
              </select>
            </div>
          </div>
        <div class="form-group">
          <label class="col-sm-2 control-label" for="txtNotice"> Noticia </label>
          <div class="col-sm-6">
