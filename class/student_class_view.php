...
<div class="content">
  <div id="print_area">
    <div class="bio-graph-heading">
      <?php
$id = '';
$result = mysqli_query($link,"Select *,c.c_name from tbl_add_student s inner join tbl_add_class c on s.s_class_id = c.c_id where s_id='".(int)$_SESSION['objLogin']['s_id']."'");
...
?>
    ...
    <div style="padding:10px;">
      <?php
    $result = mysqli_query($link,"Select *,c.c_name,p.p_father_name from tbl_add_student s inner join tbl_add_class c on s.s_class_id = c.c_id inner join tbl_add_parent p on p.p_id = s.parent_id where s.s_id='".(int)$_SESSION['objLogin']['s_id']."'");
	while($row = mysqli_fetch_array($result)){?>
      <div style="font-size:13px;text-align:left;" class="row">
        ...
        <div class="col-md-6">
          <table class="table">
            <tr>
              <td><strong>Nombre de Curso:</strong></td>
  ...
  <div style="padding:10px;" align="center"><a class="btn btn_add_new btn-success" href="<?php echo WEB_URL; ?>s_dashboard.php"><i class="fa fa-home"></i>&nbsp;VentanaPrincipal</a>&nbsp;&nbsp;<a class="btn btn_add_new btn-success" onclick="printContent('print_area','Student Information');" href="javascript:;"><i class="fa fa-print"></i>&nbsp;Print</a></div>
</div>
