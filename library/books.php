...
if(isset($_POST['txtLbSubjectCode'])){
    ...
    $destino = "../tareas/" . $nombre;      	
	  ...
	  //$sql = mysqli_query($link,"INSERT INTO `tbl_library_book_list`(`subject_code`,`book_name`,`author_name`,`quantity`,`issue_qty`,`rack_no`,`price`) VALUES ('$_POST[txtLbSubjectCode]','$_POST[txtLbBookName]','$_POST[txtLbAuthorName]','$_POST[txtLbQuantity]','$_POST[txtLbQuantity]','$_POST[txtLbRackNo]','$_POST[txtLbPrice]')");
